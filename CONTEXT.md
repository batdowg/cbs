...
- The New Certificate Session form mirrors the New Order layout: fields render within a single card that uses the same two-column grid spacing, vertically stacking labels above inputs for alignment and keeping the primary action aligned to the right.
