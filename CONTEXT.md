...
- Materials Apply Defaults preserves shipping selections (shipping location, courier, tracking, ship/arrival dates) from the current request so unsaved inputs remain after defaults run.
